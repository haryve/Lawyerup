...
class _LawyerProfileuWidgetState extends State<LawyerProfileuWidget>
    with TickerProviderStateMixin {
  late LawyerProfileuModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LawyerProfileuModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<LawyersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        final lawyerProfileuLawyersRecord =
