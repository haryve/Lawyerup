...
/// Make this page and fix its layout
class AuthenticateSolo1Widget extends StatefulWidget {
  const AuthenticateSolo1Widget({super.key});

  static String routeName = 'AuthenticateSolo1';
  static String routePath = '/authenticateSolo1';

  @override
  State<AuthenticateSolo1Widget> createState() =>
...
class _AuthenticateSolo1WidgetState extends State<AuthenticateSolo1Widget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'AuthenticateSolo1'});
    ...
    _model.emailAddressLoginFocusNode!.addListener(() => safeSetState(() {}));
        ...
        body: Container(
          ...
          decoration: BoxDecoration(
            image: DecorationImage(
              fit: BoxFit.cover,
              image: Image.asset(
                'assets/images/ChatGPT_Image_Apr_13,_2025,_01_03_02_PM.png',
              ).image,
            ),
          ),
          child: Column(
                      ...
                      Align(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Lottie.asset(
                              'assets/jsons/Animation_-_1731843410169.json',
                              width: 200.0,
                              height: 100.0,
                              fit: BoxFit.contain,
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [Color(0x7367A8DB), Color(0xD8E0E3E7)],
                    stops: [0.0, 1.0],
                      ...
                      Align(
                        ...
                        child: FlutterFlowButtonTabBar(
                          ...
                          unselectedLabelColor:
                              FlutterFlowTheme.of(context).primaryBackground,
                          backgroundColor: Color(0x1403A9F4),
                                      ...
                                      Expanded(
                                        child: Padding(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'AUTHENTICATE_SOLO1_Button-Login_ON_TAP');
                                              logFirebaseEvent(
                                                  'Button-Login_auth');
                                              GoRouter.of(context)
                                                  .prepareAuthEvent();
                                      ...
                                      Align(
                                        ...
                                        child: Padding(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'AUTHENTICATE_SOLO1_Button-ForgotPassword');
                                              logFirebaseEvent(
                                                  'Button-ForgotPassword_navigate_to');

                                              context.pushNamed(
                                                  BforgotpasswordWidget
                                                      .routeName);
                                            },
                                      ...
                                      Expanded(
                                        child: Padding(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'AUTHENTICATE_SOLO1_SIGN_UP_BTN_ON_TAP');
                              ...
                              child: Row(
                                ...
                                children: [
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'AUTHENTICATE_SOLO1_Container_u8bf0gvq_ON');
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'AUTHENTICATE_SOLO1_Container_ig3670vf_ON');
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'AUTHENTICATE_SOLO1_Container_5vwj63y9_ON');
                                      logFirebaseEvent('Container_auth');
                                      GoRouter.of(context).prepareAuthEvent();
                                      final user = await authManager
