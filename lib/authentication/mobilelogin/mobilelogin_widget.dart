...
import 'mobilelogin_model.dart';
export 'mobilelogin_model.dart';
...
class _MobileloginWidgetState extends State<MobileloginWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'mobilelogin'});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Color(0x7A03A9F4),
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('MOBILELOGIN_arrow_back_rounded_ICN_ON_TA');
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        'Use Mobile No.  below to sign in.',
                        style: FlutterFlowTheme.of(context)
                            .labelMedium
                            .override(
                              font: GoogleFonts.plusJakartaSans(
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'MOBILELOGIN_PAGE_SEND_O_T_P_BTN_ON_TAP');
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'MOBILELOGIN_CONTINUE_WITH_GOOGLE_BTN_ON_');
                                      logFirebaseEvent('Button_auth');
                                ...
                                isAndroid
                                    ...
                                    : Padding(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'MOBILELOGIN_CONTINUE_WITH_APPLE_BTN_ON_T');
                                            logFirebaseEvent('Button_auth');
                                            GoRouter.of(context)
                                                .prepareAuthEvent();
                                            final user = await authManager
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'MOBILELOGIN_CONTINUE_WITH_EMAIL_BTN_ON_T');
                                      logFirebaseEvent('Button_navigate_to');
