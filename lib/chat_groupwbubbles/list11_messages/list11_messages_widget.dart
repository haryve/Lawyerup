  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> list11MessagesUsersRecordList = snapshot.data!;

        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final list11MessagesUsersRecord =
            list11MessagesUsersRecordList.isNotEmpty
                ? list11MessagesUsersRecordList.first
                : null;
                      ...
                      onTap: () async {
                        await ChatsRecord.collection.doc().set({
                          ...createChatsRecordData(
                            ...
                            userB: list11MessagesUsersRecord?.reference,
                            lastMessage: 'NA',
                            lastMessageTime: getCurrentTimestamp,
                            chatimage: list11MessagesUsersRecord?.photoUrl,
                          ),
                          ...mapToFirestore(
                            {
                                  ...
                                  onTap: () async {
                                    await ChatsRecord.collection.doc().set({
                                      ...createChatsRecordData(
                                        user: currentUserReference?.id,
                                        userA: currentUserReference,
                                        userB: list11MessagesUsersRecord
                                            ?.reference,
                                        lastMessage: 'NA',
                                        lastMessageTime: getCurrentTimestamp,
                                        chatimage:
                                            list11MessagesUsersRecord?.photoUrl,
                                      ),
                                      ...mapToFirestore(
                                        {
