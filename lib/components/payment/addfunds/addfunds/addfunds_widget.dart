...
class _AddfundsWidgetState extends State<AddfundsWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Addfunds'});
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('ADDFUNDS_chevron_left_rounded_ICN_ON_TAP');
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(8.0, 20.0, 16.0, 15.0),
                    child: Text(
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('ADDFUNDS_PAGE_ADD_FUNDS_BTN_ON_TAP');
                      logFirebaseEvent('Button_navigate_to');

                      context.pushNamed(
                        AddfundCheckoutWidget.routeName,
                        queryParameters: {
