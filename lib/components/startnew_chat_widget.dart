...
import 'startnew_chat_model.dart';
export 'startnew_chat_model.dart';
...
class StartnewChatWidget extends StatefulWidget {
  ...
  @override
  State<StartnewChatWidget> createState() => _StartnewChatWidgetState();
}
    ...
    return Align(
      ...
      child: StreamBuilder<UsersRecord>(
        ...
        builder: (context, snapshot) {
          ...
          final card46StartNewChatUsersRecord = snapshot.data!;
                              ...
                              child: Column(
                                ...
                                children: [
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'STARTNEW_CHAT_COMP_Icon_25y0ezlk_ON_TAP');
                            ...
                            children: [
                              Container(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'STARTNEW_CHAT_COMP_BACK_BTN_ON_TAP');
                              ...
                              Container(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'STARTNEW_CHAT_GO_TO_CHATTING_BTN_ON_TAP');
