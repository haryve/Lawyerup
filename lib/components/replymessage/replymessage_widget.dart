...
import 'replymessage_model.dart';
export 'replymessage_model.dart';

/// a component from bottomsheet to reply a comment
class ReplymessageWidget extends StatefulWidget {
  const ReplymessageWidget({
    super.key,
    required this.replymesref,
    required this.chatid,
  });

  final DocumentReference? replymesref;
...
class _ReplymessageWidgetState extends State<ReplymessageWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReplymessageModel());
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('REPLYMESSAGE_COMP_CANCEL_BTN_ON_TAP');
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('REPLYMESSAGE_COMP_REPLY_BTN_ON_TAP');
                      ...
                      await MessagesRecord.createDoc(widget.chatid!)
                        ...
                        type: 'text',
                        messagerepliesto: widget.replymesref,
                      ));
                      logFirebaseEvent('Button_bottom_sheet');
                      Navigator.pop(context);
                    },
