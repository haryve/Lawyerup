...
import '/components/replymessage/replymessage_widget.dart';
import '/components/sendimage/sendimage_widget.dart';
...
class ChattingPageWidget extends StatefulWidget {
  ...
  static String routeName = 'chatting_page';
...
class _ChattingPageWidgetState extends State<ChattingPageWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'chatting_page'});
                                          ...
                                          Align(
                                            ...
                                            child: Padding(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'CHATTING_PAGE_PAGE_lawyermessage_ON_TAP');
                                                  logFirebaseEvent(
                                                      'lawyermessage_bottom_sheet');
                                                                        ...
                                                                        return Material(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                if (replyyMessagesRecord.type == 'text')
                                                                                  Align(
                                                                                    alignment: AlignmentDirectional(-1.0, -1.0),
                                                                                    child: Text(
                                                                                      replyyMessagesRecord.messagetext,
                                                                                ...
                                                                                if (replyyMessagesRecord.type == 'audio')
                                                                                  Row(
                                                                                    mainAxisSize: MainAxisSize.max,
                                                                                    children: [
                                                                                      Icon(
                                                                                ...
                                                                                if (replyyMessagesRecord.type == 'image')
                                                                                  Row(
                                                                                    mainAxisSize: MainAxisSize.max,
                                                                                      ...
                                                                                      Padding(
                                                                                        ...
                                                                                        child: ClipRRect(
                                                                                          ...
                                                                                          child: CachedNetworkImage(
                                                                                            ...
                                                                                            imageUrl: replyyMessagesRecord.messageImage,
                                                                                            width: 45.0,
                                                                                            height: 45.0,
                                                                                            fit: BoxFit.cover,
                                                                                          ),
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onTap:
                                                                            () async {
                                                                          logFirebaseEvent(
                                                                              'CHATTING_PAGE_PAGE_Image_9cnohy8w_ON_TAP');
                                                                          logFirebaseEvent(
                                                                              'Image_expand_image');
                                                                          await Navigator
                                                                              .push(
                                                                            ...
                                                                            PageTransition(
                                                                              ...
                                                                              child: FlutterFlowExpandedImageView(
                                                                                image: CachedNetworkImage(
                                                                                  fadeInDuration: Duration(milliseconds: 500),
                                                                                  fadeOutDuration: Duration(milliseconds: 500),
                                                                                  imageUrl: listViewMessagesRecord.messageImage,
                                                                                  fit: BoxFit.contain,
                                                                                ),
                                                                                allowRotation: false,
                                                                                tag: listViewMessagesRecord.messageImage,
                                        ...
                                        if (listViewMessagesRecord.senderID ==
                                          ...
                                          Padding(
                                            ...
                                            child: InkWell(
                                              ...
                                              onLongPress: () async {
                                                logFirebaseEvent(
                                                    'CHATTING_Column_k7jeeyn9_ON_LONG_PRESS');
                                                logFirebaseEvent(
                                                    'Row_bottom_sheet');
                                                await showModalBottomSheet(
                                                  isScrollControlled: true,
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      onTap:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'CHATTING_PAGE_PAGE_Image_3qr1ydnt_ON_TAP');
                                                                        logFirebaseEvent(
                                                                            'Image_expand_image');
                                                                        await Navigator
                                                                            .push(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            fadeOutDuration:
                                                                                Duration(milliseconds: 500),
                                                                            imageUrl:
                                                                                listViewMessagesRecord.messageImage,
                                                                            width:
                                                                                270.0,
                                                                            height:
                                                                                300.0,
                                                                        ...
                                                                        children: [
                                                                          Align(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Stack(
                                                                                children: [
                                                                                  if (rowChatsRecord.lastmessageseen)
                                                                                    FaIcon(
                                                                                      FontAwesomeIcons.checkDouble,
                                                                                      color: Color(0xFF145BC4),
                                                                                      size: 16.0,
                                                                                    ),
                                                                                  if (!rowChatsRecord.lastmessageseen)
                                                                                    Icon(
                      ...
                      child: Row(
                        ...
                        children: [
                          InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'CHATTING_PAGE_PAGE_Icon_pixd9tnf_ON_TAP');
                          ...
                          if (functions.guestImage(
                                      widget.participantsimages!.toList(),
                                      currentUserPhoto) !=
                                  null &&
                          ...
                          Padding(
                            ...
                            child: AuthUserStreamWidget(
                              builder: (context) => Text(
                                valueOrDefault<String>(
                                  functions.guestName(
                                      widget.participantnames!.toList(),
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'CHATTING_PAGE_PAGE_Icon_6022f70s_ON_TAP');
                                          ...
                                          child: Container(
                                            ...
                                            child: Padding(
                                              ...
                                              child: FlutterFlowIconButton(
                                                ...
                                                onPressed: () async {
                                                  logFirebaseEvent(
                                                      'CHATTING_PAGE_PAGE_send_sharp_ICN_ON_TAP');
                                                  logFirebaseEvent(
