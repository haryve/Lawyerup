                          ...
                          Expanded(
                            child: StreamBuilder<List<LawyerstalkRecord>>(
                              stream: queryLawyerstalkRecord(
                                queryBuilder: (lawyerstalkRecord) =>
                                    lawyerstalkRecord.orderBy('SENDERTS',
                                        descending: true),
                              ),
                              builder: (context, snapshot) {
                                ...
                                List<LawyerstalkRecord>
                                    listViewLawyerstalkRecordList =
                                    snapshot.data!;
                                ...
                                return ListView.builder(
                                  ...
                                  itemCount:
                                      listViewLawyerstalkRecordList.length,
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        fadeOutDuration:
                                                                            Duration(milliseconds: 500),
                                                                        imageUrl:
                                                                            listViewLawyerstalkRecord.senderimg,
                                                                        width:
                                                                            285.0,
                                                                        height:
                                                                            300.0,
                                                                      ...
                                                                      children: [
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                              Stack(
                                                                            children: [
                                                                              if ((isWeb ? MediaQuery.viewInsetsOf(context).bottom > 0 : _isKeyboardVisible) == true)
                                                                                FaIcon(
                                                                                  FontAwesomeIcons.checkDouble,
                                                                                  color: Color(0xFF145BC4),
                                                                                  size: 16.0,
                                                                                ),
                                                                              if ((isWeb ? MediaQuery.viewInsetsOf(context).bottom > 0 : _isKeyboardVisible) == false)
                                                                                Icon(
                                                                                  Icons.check_rounded,
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            valueOrDefault<String>(
                                                                              dateTimeFormat(
                                                                                "relative",
                                                                                listViewLawyerstalkRecord.senderts,
                              ...
                              Align(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    ...
                                    safeSetState(() {
                                      _model.isDataUploading_messageimage =
                                          false;
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    ...
                                    if (selectedMedia != null &&
                                      ...
                                      safeSetState(() => _model
                                          .isDataUploading_messageimage = true);
                                          ...
                                          child: FlutterFlowIconButton(
                                            ...
                                            onPressed: () async {
                                              ...
                                              if (_model.uploadedFileUrl_messageimage !=
                                                ...
                                                await LawyerstalkRecord
                                                    .collection
                                                    .doc()
                                                    .set(
                                                        createLawyerstalkRecordData(
                                                      sENDERid:
                                                          currentUserReference,
                                                      sendername:
                                                          currentUserDisplayName,
