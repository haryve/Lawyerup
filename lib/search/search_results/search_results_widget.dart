            ...
            children: [
              Row(
                ...
                children: [
                  Expanded(
                    child: Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(10.0, 10.0, 2.0, 10.0),
                      child: Material(
                                ...
                                fieldViewBuilder: (
                                  ...
                                  return TextFormField(
                                    ...
                                    onFieldSubmitted: (_) async {
                                      logFirebaseEvent(
                                          'SEARCH_RESULTS_TextField_rjy5i9zn_ON_TEX');
                                      logFirebaseEvent(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'SEARCH_RESULTS_PAGE_Icon_6ui8afos_ON_TAP');
                              logFirebaseEvent('Icon_simple_search');
                              await queryLawyersRecordOnce()
                                  .then(
              ...
              Column(
                ...
                children: [
                  Builder(
                    builder: (context) {
                      final lawyersearch = _model.simpleSearchResults1
                          .toList()
                          .take(20)
                          .toList();
                      ...
                      return ListView.builder(
                        ...
                        itemCount: lawyersearch.length,
                        itemBuilder: (context, lawyersearchIndex) {
                          final lawyersearchItem =
                              lawyersearch[lawyersearchIndex];
                          return Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                4.0, 0.0, 4.0, 8.0),
                            child: Container(
                                      ...
                                      children: [
                                        Align(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'SEARCH_RESULTS_Stack_dhlw6gbj_ON_TAP');
                                              logFirebaseEvent(
                                                  'Stack_navigate_to');
                                        ...
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'SEARCH_RESULTS_Container_9qe32rj5_ON_TAP');
                                            logFirebaseEvent(
                                          ...
                                          child: wrapWithModel(
                                            ...
                                            child: RatingbarWidget(
                                              key: Key(
                                                'Key9qe_${lawyersearchItem.author!.id}',
                                              ),
                                            ),
                                          ),
                                        ),
                                    ...
                                    Expanded(
                                      child: Align(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'SEARCH_RESULTS_Column_k480wkyz_ON_TAP');
                                            logFirebaseEvent(
                                                'Column_navigate_to');
                                            ...
                                            children: [
                                              ...
                                              Align(
                                                alignment: AlignmentDirectional(
                                                    -1.0, 0.0),
                                                child: Text(
                                                  '${lawyersearchItem.experttype} : ${lawyersearchItem.category}',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .labelMedium
                                                      .override(
                                              ...
                                              Text(
                                                'Specialty : ${lawyersearchItem.type}',
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .labelMedium
                                                    .override(
                                              ...
                                              Text(
                                                'Exp: ${lawyersearchItem.practicetime.toString()} Years',
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .labelMedium
                                                    .override(
                                                    ...
                                                    children: [
                                                      wrapWithModel(
                                                        ...
                                                        child:
                                                            CallbuttonnewWidget(
                                                          key: Key(
                                                            'Keyifb_${lawyersearchItem.reference.id}',
                                                          ),
                                                          parameter1:
                                                              lawyersearchItem
                                                                  .author,
                                                      ...
                                                      wrapWithModel(
                                                        ...
                                                        child:
                                                            NewchatbuttonWidget(
                                                          key: Key(
                                                            'Key5wd_${lawyersearchItem.author!.id}',
                                                          ),
                                                          lawref:
                                                              lawyersearchItem
                                                                  .reference,
                                                      ...
                                                      wrapWithModel(
                                                        ...
                                                        child:
                                                          ...
                                                          key: Key(
                                                            'Keys75_${lawyersearchItem.author!.id}',
                                                          ),
                                                          parameter1:
                                                              lawyersearchItem
                                                                  .author,
                                          ...
                                          Row(
                                            ...
                                            children: [
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Text(
                                                    valueOrDefault<String>(
                                                      '₹ ${lawyersearchItem.lawyerCharge.toString()}/min',
                                                      '₹ 15/min',
                                                    ),
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                              ...
                                              InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'SEARCH_RESULTS_PAGE_Icon_a22r59m6_ON_TAP');
                                                  logFirebaseEvent(
                                                      'Icon_bottom_sheet');
                                                  await showModalBottomSheet(
                                                    isScrollControlled: true,
